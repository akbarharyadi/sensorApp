...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { device_id: @measurement.device_id, value_hum: @measurement.value_hum, value_temp: @measurement.value_temp } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { device_id: @measurement.device_id, value_hum: @measurement.value_hum, value_temp: @measurement.value_temp } }
